...
PPSStepMaxMessenger::PPSStepMaxMessenger(PPSStepMax* stepM)
:pStepMax(stepM)
{ 
...
PPSStepMaxMessenger::~PPSStepMaxMessenger()
{
  delete StepMaxCmd;
}
...
void PPSStepMaxMessenger::SetNewValue(G4UIcommand* command, G4String newValue)
{ 
